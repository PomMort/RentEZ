          ...
          <table className="table-auto w-full text-left text-sm sm:text-base">
            <thead>
              <tr>
                ...
                <th className="border-b py-3 hidden sm:table-cell">Đơn giá</th>
                <th className="border-b py-3">Số lượng</th>
                <th className="border-b py-3 hidden sm:table-cell">Số tiền</th>
              ...
              {cart.map((c, index) => {
                ...
                return (
                  <React.Fragment key={index}>
                    <tr>
                      <td colSpan="5" className="bg-[#f5f5f5] py-2 font-bold">
                        <label className="inline-flex items-center ml-2 sm:ml-[20px]">
                          <input
                            type="checkbox"
                            checked={allSelected}
                            onChange={(e) =>
                              toggleSelectAllInShop(index, e.target.checked)
                            }
                          ...
                          <p className="ml-2 text-sm sm:text-base">{c.shop}</p>
                        </label>
                      </td>
                    </tr>
                      ...
                      <tr key={product.id} className="border-b">
                        <td className="py-4 flex flex-col sm:flex-row sm:items-center">
                          ...
                          <div className="text-sm sm:text-base">
                            ...
                            <p className="text-gray-500">
                              Nhận: {product?.rentDateTime?.formattedDate} -{" "}
