    ...
    return (
        <Grid item xs={6}>
            <div className='justify-center flex flex-row rounded-lg shadow hover:shadow-lg mb-3 shadow-gray-500 pr-12 max-h-[300px] min-w-[750px] '>
                <img className='w-44 scale-75 max-h-[235px]' src={cart.product.image} />
                ...
                <div className='mt-5 min-w-[200px] flex-1'>
                    ...
                    <div className='flex justify-between mt-9 my-3 items-center'>
                        ...
                        <div className='flex items-center'>
                            ...
                            <input type="text" id="quantity-input" data-input-counter aria-describedby="helper-text-explanation" className="bg-gray-50 border-x-0 border-gray-300 h-11 text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-2/5 py-2.5 bg-yellow-300 shadow-lg shadow-yellow-200/60  dark:placeholder-gray-400 text-black dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="999" value={quantity} required />
